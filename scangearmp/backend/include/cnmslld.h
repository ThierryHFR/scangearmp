...
typedef int ( *FPCANON_GET_ABILITY_VER ) ( int * );
typedef int ( *FPCANON_GET_ABILITY ) ( void * );
typedef int ( *FPCANON_GET_STATUS ) ( unsigned int * );
typedef int ( *FPCANON_GET_CALIBLATION_STATUS ) ( unsigned int * );
typedef int ( *FPCANON_GET_PARAMETERS ) ( CANON_SCANDATA * );
typedef int ( *FPCANON_END_SCAN ) ( void );
typedef int ( *FPCANON_SET_TBLPATH ) ( const char * );
typedef int ( *FPCANON_SET_PARAMETER_EX ) ( int, int, int, int, int, int, int, int, int, unsigned short*, CANON_SCANDATA *, CANON_SCANOPTS * );

typedef int ( *FPCANON_GET_DEVICESETTINGS ) ( void * );
typedef int ( *FPCANON_SET_DEVICESETTINGS ) ( void * );
...
typedef struct {
	...
	FPCANON_GET_ABILITY_VER			p_canon_get_ability_ver;
	FPCANON_GET_ABILITY				p_canon_get_ability;
	...
	FPCANON_SET_TBLPATH				p_canon_set_tblpath;
	FPCANON_SET_PARAMETER_EX		p_canon_set_parameter_ex;
	FPCANON_GET_DEVICESETTINGS		p_canon_get_devicesettings;
	FPCANON_SET_DEVICESETTINGS		p_canon_set_devicesettings;
} CNMSLLDAPI;
