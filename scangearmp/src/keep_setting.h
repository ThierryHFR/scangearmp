...
enum{
	KEEPSETTING_ID_RESET_SETTING = 0,
	KEEPSETTING_ID_OVER_100MB,
	KEEPSETTING_ID_MAX,
};
...
CNMSInt32 KeepSettingOpen( CNMSLPSTR lpModelStr );
CNMSVoid  KeepSettingClose( CNMSVoid );

CNMSInt32 KeepSettingGetValue( CNMSInt32 id );	/* get value from file */
CNMSInt32 KeepSettingSetValue( CNMSInt32 id, CNMSInt32 value );	/* set value to file */
